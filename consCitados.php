  ...
  <section class="full-width pageContent">
    <!-- navBar -->
     <?php 
      ...
      <h3 class="text-center tittles">Bienvenido Al Área De Recepción</h3>
      <!-- Tiles -->
      ...
      <div class="mdl-cell mdl-cell--12-col">
        <div class="full-width panel mdl-shadow--2dp">
          ...
          <div class="full-width panel-content">
           <form method="POST" action="pacCitados.php">
              <div class="mdl-grid">
                <div class="mdl-cell mdl-cell--12-col">
              ...
              <p class="text-center">
                <button name="reporcitados" class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect mdl-button--colored bg-primary" id="btn-addCompany"  onclick="return confirm('¿Está seguro?')">
                  <i class="zmdi zmdi-plus"></i>
                </button>
                <div class="mdl-tooltip" for="btn-addCompany">Consultar</div>
              </p>
            </form>
