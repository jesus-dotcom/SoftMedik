...
session_start();
$fechaGlobal = $_SESSION['fecha_global'];

$consultas = "SELECT * FROM paciente WHERE idPaciente";
    ...
    <section class="full-width header-well">
      ...
      <div class="full-width header-well-text">
        <p class="text-condensedLight">
          Asigne Cita a Pacientes ya registrados en el Sistema.
        </p>
      </div>
    </section>
      ...
      <div class="mdl-cell mdl-cell--12-col">
        <div class="full-width panel mdl-shadow--2dp">
          ...
          <div class="full-width panel-content">
            <form name="f1" method="post" action="controllerPrueba.php">
              <div class="mdl-grid">
                <div class="mdl-cell mdl-cell--12-col">
         ...
         <input type="tel"  name="paciente" class="mdl-textfield__input" value="<?php echo $id; ?>">
                ...
                <div class="mdl-cell mdl-cell--4-col mdl-cell--1-col-tablet">
                  <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    ...
                    <input name="fechacita" class="mdl-textfield__input" type="date" id="fecha" value="<?php echo $fechaGlobal; ?>" required>
                  </div>
                </div>
                <div class="mdl-cell mdl-cell--4-col mdl-cell--1-col-tablet">
                  <div class="mdl-textfield mdl-js-textfieldmdl-textfield--floating-label">
                   ...
                   <select  name="costo" class="mdl-textfield__input">
                    ...
                    <option value="1">50.000.000,00</option>
                    <option value="2">40.000.000,00</option>
